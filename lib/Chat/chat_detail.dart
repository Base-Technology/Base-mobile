...
class _ChatDetailPageState extends State<ChatDetailPage> {
  List<ChatMessage> messages = [
    ...
    ChatMessage(messageContent: "Doing OK. How about you?", messageType: "sender"),
            ...
            child: Row(
              ...
              Expanded(
                child: Column(
                  ...
                  children: <Widget>[
                    Text("Fredericking", style: TextStyle(fontSize:16, fontWeight:FontWeight.w600),),
                    SizedBox(height: 6,),
                  ],
                  ), 
              ),
                ...
                child: Align(
                  ...
                  child: Container(
                    decoration: BoxDecoration(
                      ...
                      color: (messages[index].messageType == "receiver"?Colors.white:Colors.green[100]),
                    ),
