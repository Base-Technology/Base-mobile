...
import 'package:acy_ipay/controller/member_controller.dart';
import 'package:acy_ipay/controller/user_controller.dart';
import 'package:acy_ipay/chatnew/controller/chat_detail_controller.dart';
import 'package:acy_ipay/chatnew/qrcode_group_chat_page.dart';
import 'package:acy_ipay/utils/navigator_utils.dart';
import 'package:acy_ipay/widget/avatar_widget.dart';
import 'package:acy_ipay/core.dart';
import 'package:acy_ipay/widget/common_switch.dart';
import 'package:acy_ipay/widget/lable_widget.dart';
...
class ChatDetailPage extends BaseGetBuilder<ChatDetailContoller> {
  ...
  Widget _buildAvatarHeader(BuildContext context) {
    ...
    footWidgets.add(TapWidget(
      onTap: () async {
        var usernames =null; //await NavigatorUtils.toNamed(SelectFriendPage.routeName,arguments: SelectFriendArguments(title: Ids.create_chat.str(),selectedUsername: controller.conversation.membersStr));
        if(usernames != null){
          if(controller.conversation.isGroup){
